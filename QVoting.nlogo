...
to-report voice-credits-spent [active-referendum]
  ...
  [min list ( (item [referendum-number] of active-referendum utilities * marginal-pivotality) ^ 2) voice-credits ]  ;; JACOB: Makes sense, but somethine like this should be commented
  [(item [referendum-number] of active-referendum utilities * marginal-pivotality) ^ 2]

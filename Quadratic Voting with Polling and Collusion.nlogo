...
; TODO: I think the proportion of strategic vote should be removed.  It fullfills the same function and proportion of strageic voters
...
to vote-QV
  ...
  foreach [advantage] of colluding-turtles [p -> set total-advantage (map [[x y] -> x + y] total-advantage p)]
  ...
  ask colluding-turtles [
    ...
    ask new-colluder-set [
      ...
      if any? link-neighbors [
        ...
        ask link-neighbors [
          let identical? not member? false (map [[u n-u] -> u = n-u] utility-doctrine [utility-doctrine] of new-turtle)
          if
            ...
            let difference-new sum (map [[u d] -> abs(u - d)] [utilities] of myself [utility-doctrine] of new-turtle)
            let difference-old sum (map [[u d] -> abs(u - d)] [utilities] of myself utility-doctrine)
            ifelse (difference-new < difference-old)[
